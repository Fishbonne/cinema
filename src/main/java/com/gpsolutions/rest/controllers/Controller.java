package com.gpsolutions.rest.controllers;


import com.gpsolutions.rest.dao.Dao;
...
public class Controller {
    ...
    public ResponseEntity<Reservation> getReservationInfo(@PathVariable(value = "reservationId") int reservationId) throws IOException {
        LOG.info("get Reservation Info with id={}", reservationId);
        Reservation reservation = dao.getReserveInfo(reservationId);
